(def-doom-theme doom-molokai
    ...
    (
      ...
      (lazy-highlight :background blue :foreground base0 :distant-foreground base0 :bold bold)
      ...
      ;;;; evil
      (evil-search-highlight-persist-highlight-face :foreground base8  :background blue)
      ;;;; evil-snipe
